...
console.log("Personal Task Manager loaded!");
...
function updateStats() {
    ...
    statsText.textContent = `${emoji} ${totalTasks} personal tasks • ${completedTasks} done • ${pendingTasks} pending • ${completionRate}% complete`;
}
...
function clearAllTasks() {
    ...
    if (confirm('Are you sure you want to clear all personal tasks? This cannot be undone.')) {
        tasks = [];
        saveTasks();
        renderTasks();
        updateStats();
